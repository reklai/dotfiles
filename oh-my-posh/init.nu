...
let _omp_executable: string = (echo "/home/reklai/.local/bin/oh-my-posh")
...
$env.POSH_SESSION_ID = "0c49f29c-6f4c-442f-ab8d-ebf7a18ee202"
# pinned to the session's configuration so it can be recovered when the session cache is lost
$env.POSH_CONFIG = "/home/reklai/.config/oh-my-posh/config.json"
$env.POSH_SHELL = "nu"
